...
public class FollowTrackingCamera : MonoBehaviour
{
	...
	public void Rotate(float wantedAngle){
		wantedRotationAngle += wantedAngle;
	...
	public void Zoom(float scale){
		...
		heightWanted -= zoomStep * scale * heightRatio;
		distanceWanted -= zoomStep * scale;
		
		// Make sure they meet our min/max values.
		heightWanted = Mathf.Clamp(heightWanted, min* heightRatio, max * heightRatio);
